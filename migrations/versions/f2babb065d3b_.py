...
Revision ID: f2babb065d3b
Revises: cac308d2885b
Create Date: 2021-03-28 11:30:43.507264
...
revision = 'f2babb065d3b'
down_revision = 'cac308d2885b'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.Column('genres', postgresql.ARRAY(sa.TEXT()), autoincrement=False, nullable=True),
